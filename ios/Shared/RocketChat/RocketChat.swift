...
final class RocketChat {
  ...
  static private var queue = DispatchQueue(label: "de.a6n.rocketchat.instanceQueue")
  private var encryptionQueue = DispatchQueue(label: "de.a6n.rocketchat.encryptionQueue")
